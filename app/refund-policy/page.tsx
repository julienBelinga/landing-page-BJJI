      ...
      <div className={styles.content}>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>
            Chez BJJ Insight, nous nous efforçons de fournir une application de
            qualité qui répond à vos attentes. Si vous n'êtes pas entièrement
            satisfait de votre achat, nous proposons une politique de
            remboursement équitable et transparente.
          </p>
        </div>
        ...
        <div className={styles.highlight}>
          ...
          <p className={styles.highlightText}>
            Les achats effectués via Google Play Store sont soumis à leur propre
            politique de remboursement. Vous devez d'abord contacter Google Play
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>
            Pour être éligible à un remboursement, votre demande doit respecter
            les conditions suivantes :
          </p>
          <ul className={styles.list}>
            <li>La demande est effectuée dans les 14 jours suivant l'achat</li>
            <li>
            ...
            <li>
              Vous acceptez la suppression définitive de votre compte et de vos
              données
            </li>
          </ul>
        </div>
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>
            ...
            <strong>5 jours ouvrables</strong>. Si votre demande est approuvée,
            le remboursement sera effectué sous 7 à 14 jours selon votre méthode
        ...
        <div className={styles.section}>
          ...
          <p className={styles.text}>
            Dans certains cas, nous pouvons proposer un remboursement partiel si
            :
          </p>
          <ul className={styles.list}>
            <li>
              Vous avez utilisé l'application pendant une période significative
            </li>
        ...
        <div className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li>
              Changement d'avis sans raison valable après utilisation extensive
            </li>
          </ul>
        </div>
