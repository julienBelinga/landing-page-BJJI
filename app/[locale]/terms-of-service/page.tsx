...
export default function TermsOfServicePage() {
  return (
    <>
      <MetaHead pageKey="termsOfService" />
        ...
        <div className={styles.content}>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.text}>
              En utilisant l'application BJJ Insight, vous acceptez d'être lié
              par ces conditions d'utilisation. Si vous n'acceptez pas ces
              conditions, veuillez ne pas utiliser notre application.
            </p>
          </div>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.text}>
              ...
              sont protégés par les droits d'auteur et appartiennent à BJJ
              Insight ou à ses partenaires. Toute reproduction non autorisée est
          ...
          <div className={styles.section}>
            ...
            <p className={styles.text}>
              ...
              régis par notre politique de confidentialité. Nous nous engageons
              à protéger votre vie privée conformément au RGPD.
            </p>
          </div>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.text}>
              ...
              L'application est fournie "en l'état" sans garantie de
          ...
          <div className={styles.section}>
            ...
            <p className={styles.text}>
              ...
              importants par notification dans l'application ou par e-mail.
            </p>
          </div>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.text}>
              Vous pouvez cesser d'utiliser l'application à tout moment. Nous
              nous réservons le droit de suspendre ou de résilier votre accès en
