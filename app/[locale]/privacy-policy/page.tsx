...
export default function PrivacyPolicyPage() {
  return (
    <>
      <MetaHead pageKey="privacyPolicy" />
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <p className={styles.text}>
            Nous collectons uniquement les données personnelles nécessaires au
            bon fonctionnement de l'application et pour vous offrir la meilleure
            expérience possible. Cela peut inclure votre nom, votre adresse
            e-mail et vos préférences d'entraînement.
          </p>
          ...
          <p className={styles.text}>
            ...
            l'utilisation de vos données telles que décrites dans cette
            politique de confidentialité. Pour toute question ou pour demander
            la suppression de vos données, contactez-nous.
          </p>
        </div>
      </div>
    </>
